...
"""
    Implementation of "Sigmoid", "Linear", "Hyperbolic Tangent Sigmoid" and "Positive Linear" activation functions.
"""
class CL_ActivationFunctions():
    ...
    def __init__(self, master):
        ...
        self.input_weight_slider = Tk.Scale(self.sliders_frame, variable=Tk.DoubleVar(), orient=Tk.HORIZONTAL,
                                  ...
                                  label="Input Weight", command=lambda event: self.input_weight_slider_callback())
        ...
        self.bias_slider = Tk.Scale(self.sliders_frame, variable=Tk.DoubleVar(), orient=Tk.HORIZONTAL,
                                  ...
                                  activebackground="#FF0000",
                                  highlightcolor="#00FFFF",
                                  label="Bias", length=800,width=20,command=lambda event: self.bias_slider_callback())
        ...
        self.learning_method_dropdown=Tk.OptionMenu(self.buttons_frame,self.learning_method_variable, 
        											"Sigmoid","Linear","Hyperbolic Tangent Sigmoid","Positive Linear",
    ...
    def display_activation_function(self):
        ...
        elif self.learning_method=="Hyperbolic Tangent Sigmoid":
        	"""
        		Added "Hyperbolic Tangent Sigmoid" activation function.
        	"""
        	activation = (np.exp(net_value) - np.exp(-net_value))/(np.exp(net_value) + np.exp(-net_value))
        elif self.learning_method=="Positive Linear":
        	"""
        		Added "Positive Linear" activation function.
        	"""
        	activation = np.where(net_value < 0, 0, net_value);
